...
public class cliente_micuenta extends Fragment {
    ...
    public cliente_micuenta() {
        super(R.layout.fragment_cliente_micuenta);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textView_nombre = view.findViewById(R.id.cliente_micuenta_nombre);
        textView_email = view.findViewById(R.id.cliente_micuenta_email);
        textView_celular = view.findViewById(R.id.cliente_micuenta_celular);
        textView_dni = view.findViewById(R.id.cliente_micuenta_dni);
        cargarDatos();

        // 3. para LOGOUT
        Button btnLogout = view.findViewById(R.id.cliente_micuenta_logout);
